...
# -----------------------------------------
# Load all available weekly results (FULL DATA)
# -----------------------------------------
all_weeks = []

for wk in range(1, 19):
    results_path = f"Week{wk}_Results.csv"
...
season_df["spread_value"] = pd.to_numeric(season_df["spread_value"], errors="coerce")
