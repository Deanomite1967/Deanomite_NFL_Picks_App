...
# File paths
EPA_2024_PATH = "C:/DraftKings/NFL/Team_EPA_2024.csv"
EPA_2025_PATH = "C:/DraftKings/NFL/Team_EPA_2025.csv"

# Load raw CSVs exactly as they are
epa_2024 = pd.read_csv(EPA_2024_PATH)
epa_2025 = pd.read_csv(EPA_2025_PATH)
...
# Load both seasons
dl_2024 = load_team_dl(DL_2024_PATH, 2024)
dl_2025 = load_team_dl(DL_2025_PATH, 2025)
...
# Load both seasons
ol_2024 = load_team_ol(OL_2024_PATH, 2024)
ol_2025 = load_team_ol(OL_2025_PATH, 2025)
...
# Load both seasons
off_2024 = load_team_off(OFF_2024_PATH, 2024)
off_2025 = load_team_off(OFF_2025_PATH, 2025)
...
# Load both seasons
def_2024 = load_team_def(DEF_2024_PATH, 2024)
def_2025 = load_team_def(DEF_2025_PATH, 2025)
...
# Load both
off_rz = load_off_redzone(OFF_RZ_PATH)
def_rz = load_def_redzone(DEF_RZ_PATH)
