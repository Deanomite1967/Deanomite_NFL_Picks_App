...
def create_features(df):
    ...
    if "off_wepa_play" not in df.columns or "off_wepa_play_opp" not in df.columns:
        st.write("❌ MISSING EPA COLUMNS IN create_features")
        st.stop()  # hard stop so you see the debug instead of redacted KeyError
